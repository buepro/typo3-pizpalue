...
class ScssService extends AbstractService
{
    ...
    public const SETUP_FILE = 'EXT:pizpalue/Extensions/easyconf/Configuration/TypoScript/Autogenerated/SetupScssR%d.typoscript';
    public const RELATIVE_STORAGE_TS_PATH = 'module.tx_easyconf.persistence.storageRelativeScssPath';

    protected ?string $declarationFile;
