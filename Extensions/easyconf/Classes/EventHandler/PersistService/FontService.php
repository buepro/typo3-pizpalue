...
{
    protected string $googleFont;
    protected string $googleFontWeight;
    protected string $googleHeadingsFont;
    protected string $googleHeadingsFontWeight;

    public function process(): void
    {
        $this->handleGoogleFont()->handleHeadings();
    }
    ...
    protected function handleHeadings(): self
    {
    ...
    {
        $this
            ->enableGoogleNormalFont()
            ->enableGoogleHeadingsFont()
            ->updateGoogleFontUrl();
    }
    ...
    protected function includeItemInList(string $list, string $item): string
    {
        ...
        $items = [$item, ...GeneralUtility::trimExplode(',', $list, true)];
