        ...
        'tx_pizpalue_image_aspect_ratio' => [
            ...
            'config' => [
                ...
                'valuePicker' => [
                    'items' => [
                        [
                            'label' => 'LLL:EXT:pizpalue/Resources/Private/Language/locallang_db.xlf:tx_pizpalue_ttc.undefined',
                            'value' => implode(',' . chr(10), ['xxl: 0', 'xl: 0', 'lg: 0', 'md: 0', 'sm: 0', 'xs: 0']),
                        ],
                        ['label' => '2:1', 'value' => implode(',' . chr(10), ['xxl: 2.0', 'xl: 2.0', 'lg: 2.0', 'md: 2.0', 'sm: 2.0', 'xs: 2.0'])],
                        ['label' => '16:9', 'value' => implode(',' . chr(10), ['xxl: 1.7778', 'xl: 1.7778', 'lg: 1.7778', 'md: 1.7778', 'sm: 1.7778', 'xs: 1.7778'])],
                        ['label' => '4:3', 'value' => implode(',' . chr(10), ['xxl: 1.3333', 'xl: 1.3333', 'lg: 1.3333', 'md: 1.3333', 'sm: 1.3333', 'xs: 1.3333'])],
                        ['label' => '1:1', 'value' => implode(',' . chr(10), ['xxl: 1.0', 'xl: 1.0', 'lg: 1.0', 'md: 1.0', 'sm: 1.0', 'xs: 1.0'])],
                        ['label' => '3:4', 'value' => implode(',' . chr(10), ['xxl: 0.75', 'xl: 0.75', 'lg: 0.75', 'md: 0.75', 'sm: 0.75', 'xs: 0.75'])],
                        ['label' => '9:16', 'value' => implode(',' . chr(10), ['xxl: 0.5625', 'xl: 0.5625', 'lg: 0.5625', 'md: 0.5625', 'sm: 0.5625', 'xs: 0.5625'])],
                        ['label' => '1:2', 'value' => implode(',' . chr(10), ['xxl: 0.5', 'xl: 0.5', 'lg: 0.5', 'md: 0.5', 'sm: 0.5', 'xs: 0.5'])],
                    ],
                ],
                'rows' => 6,
            ],
